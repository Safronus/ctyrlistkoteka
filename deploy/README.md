...
Vyrobí se z TSV souboru — IP banované **`PERMABAN_THRESHOLD`+×** za posledních
**`WINDOW_DAYS`** dní (default 3× / 30 dní) se promotují do `nginx deny`
listu, který už není pod bantime expirací:
