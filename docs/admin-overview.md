...
- **Souřadnice úkrytů darovaných kartiček se nesmí dostat na veřejnou
  ...
  **mapa pro tým `/tym/<token>`**, zamčená náhodnou adresou i heslem a
  ...
  `/d/<token>`, ani na `/sbirka/<id>`. Nic jiného. Z celé sady prosakuje ven
