...
const ACTION_LABELS: Record<AuditAction, string> = {
  ...
  "casqb.create": "CaSQB: nový QR kód",
  "casqb.update": "CaSQB: úprava QR kódu",
  "casqb.retire": "CaSQB: vyřazení QR kódu",
  "casqb.restore": "CaSQB: obnovení QR kódu",
  "casqb.scans_reset": "CaSQB: vynulování skenů",
  "casqb.delete": "CaSQB: smazání QR kódu",
  "collage.run": "Generování koláží",
...
const ACTION_TONE: Record<AuditAction, string> = {
  ...
  "casqb.create": "bg-emerald-100 text-emerald-800",
  "casqb.update": "bg-sky-100 text-sky-800",
  "casqb.retire": "bg-amber-100 text-amber-800",
  "casqb.restore": "bg-sky-100 text-sky-800",
  "casqb.scans_reset": "bg-amber-100 text-amber-800",
  "casqb.delete": "bg-rose-100 text-rose-800",
  "collage.run": "bg-teal-100 text-teal-800",
