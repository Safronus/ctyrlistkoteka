...
import { deleteDonationPhoto } from "./delete-action";

interface Props {
  filename: string;
}

/** Two-step destructive control for a single donation photo. */
export function DeleteDonationPhotoButton({ filename }: Props) {
